...
- `status` - Status laporan (belum_dicek, belum_ditangani, dalam_penangan, aman)
- `image` - URL/path gambar (optional)
...
- `id` - Primary key
- `title` - Judul materi
- `category` - Kategori (Safety, Kesehatan)
- `description` - Caption/deskripsi
